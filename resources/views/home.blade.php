        ...
        <div class="bg-slate-800/50 border border-slate-700 rounded-3xl p-6 backdrop-blur-sm shadow-xl">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                    <a href="/docs" class="flex items-center justify-center gap-2 bg-[#BA1A1A] hover:bg-red-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200">
                        View Documentation
